...
<body>
    ...
    <div class="site-content aa_body" style="margin-bottom: 90px; text-align: left;">
        <div class="container">
            ...
            <div class="aa_essentials-table aa_big-data-table" style="margin-top:50px;">
                <table style="width:100%;">
                    ...
                    <tr>
                        <td>
                        EMC BPP Tech Foundations for Big Data
                        </td>
                        <td>
                        4 Hrs
                        </td>
                    ...
                    <tr>
                        <td>
                        Scale Out in Industry (Choose 1)
                        </td>
                        <td>
                        2 Hrs
                        </td>
                    ...
                    <tr>
                        <td>
                        Arrow Academy Big Data Workshop
                        </td>
                        <td>
                        3 Hrs
                        </td>
                    ...
                    <tr>
                        <td>
                        BPP Isilon Technical Architect
                        </td>
                        <td>
                        40 hrs
                        </td>
                    ...
                    <tr>
                        <td>
                        EMC BPP Big Data Solutions Class
                        </td>
                        <td>
                        4 Hr
                        </td>
