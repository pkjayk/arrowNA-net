<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ArrowNA.arrow_solutions.converged.vspex_blue.technical_resources.index" %>
...
<body>
    ...
    <div class="page-title-block arrow-solutions-bg">
        ...
        / <span style="font-weight: 400; font-size: 20pt;">Technical Resources</span>
    </div>
    <div class="site-content" style="margin-bottom: 120px; text-align: left;">
        ...
        <div class="container techinical_resources">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://bcove.me/gvaz4nqz">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-configuration.png">
                            </div>
                            <p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://labs.hol.vmware.com/HOL/catalogs/lab/1503">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-hands-on-lab.png">
                            </div>
                            <p>
                                EVO:RAIL Hands-On Labs
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://bcove.me/6fvlzh4f">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-management.png">
                            </div>
                            <p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://bcove.me/fy7e1dkr">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-clustering.png">
                            </div>
                            <p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://bcove.me/p6fq0vg9">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-end-2-end-experience.png">
                            </div>
                            <p>
