<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ArrowNA.arrow_solutions.converged.vspex_blue.sales_tools.index" %>
...
<body>
    ...
    <div class="page-title-block arrow-solutions-bg">
        ...
        / <span style="font-weight: 400; font-size: 20pt;">Sales Tools</span>
    </div>
    <div class="site-content" style="margin-bottom: 120px; text-align: left;">
        ...
        <div class="container techinical_resources">
            <div class="row">
                <div class="col-md-4">
                    <a target="_blank" href="http://demosondemand.com/images/SSBT//DODS_Main/1051/Assets/308.PDF">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/VSPEXBLUEFAQ.png">
                            </div>
                            <p>
                                VSPEX BLUE FAQ
                            </p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://demosondemand.com/images/SSBT/ArrowECS/Assets/159.docx">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/Emc159.png">
                            </div>
                            <p>
                                VSPEX BLUE Revised SPR Process
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://demosondemand.com/images/SSBT/ArrowECS/Assets/160.xlsx">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/Emc160.png">
                            </div>
                            <p>
                                VSPEX BLUE SPR Required Form
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VSPEX_BLUE_DataSheet.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/vspex-blue-datasheet-2.png">
                            </div>
                            <p>
                                VSPEX BLUE Hyper-Converged Infrastructure Platform
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VSPEX_BLUE_Virtualization_SO.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/vspex-blue-virtualized-environments.png">
                            </div>
                            <p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://bcove.me/9iolti5e">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evo-rail-overview.png">
                            </div>
                            <p>
                                VMware EVO:RAIL General Overview
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://www.vmware.com/files/pdf/products/evorail/vmware-evorail-faq.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/evorail-faq.png">
                            </div>
                            <p>
                                VMware EVO:RAIL FAQ
                            </p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VSPEXBlue_EUC_TR.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/euc-top-reasons.png">
                            </div>
                            <p>
                                Top Reasons: VSPEX BLUE for End-User Computing
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VSPEX_BLUE_Virtualization_TR.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/vr-top-reasons.png">
                            </div>
                            <p>
                                Top Reasons: VSPEX BLUE for Virtualized Environments
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VSPEXBlue_Cloud_Battlecard.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/cloud-battlecard.png">
                            </div>
                            <p>
                                Battle Card: VSPEX BLUE for Virtualization
                            </p>
                        </div>
                    </a>
                </div>
