<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ArrowNA.arrow_solutions.converged.vspex_blue.marketing_material.index" %>
...
<body>
    ...
    <div class="page-title-block arrow-solutions-bg">
        ...
        / <span style="font-weight: 400; font-size: 20pt;">Marketing Material</span>
    </div>
    <div class="site-content" style="margin-bottom: 120px; text-align: left;">
        ...
        <div class="container techinical_resources">
            <div class="row">
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/EMC_VspexBlue_Infographic.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/vspex-blue-infographic-3.png">
                            </div>
                            <p>
                                VSPEX BLUE InfoGraphic
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEX_BLUE_Email_Signature_Direct_English.zip">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/VSPEXBLUE_Esig-direct.png">
                            </div>
                            <p>
                                VSPEX BLUE Email Signature
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEXBlue_Poster_Partner_Preview.pdf">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/poster-partner.png">
                            </div>
                            <p>
                                VSPEX BLUE Poster
                            </p>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEX_BLUE_PullUp_Banner_Direct_English.zip">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/pullup-banner.png">
                            </div>
                            <p>
                                VSPEX BLUE Pullup Banner
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEX_BLUE_Campaign_Access_Email_Disti_to_VAR.docx">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/campaign-access-email-disti-var.png">
                            </div>
                            <p>
                                Campaign Access Email: Distributor to VAR
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEX_BLUE_Email_Copy_Block_Disti_to_VAR.docx">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="../../../../images/distributortoVAR.png">
                            </div>
                            <p>
                                Email Copy Block: Distributor to VAR
                            </p>
                        </div>
                    </a>
                </div>
            ...
            <div class="row" style="padding-top: 30px">
                <div class="col-md-4">
                    <a target="_blank" href="http://arrowenablement.blue/files/VSPEX_BLUE_Email_Copy_Block_EMC_Disti_VAR_to_Buyer.docx">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="../../../../images/vARtoBuyer.png">
                            </div>
                            <p>
                                Email Copy Block: EMC/Distributor/VAR to Buyer
                            </p>
                        </div>
                    </a>
                </div>
