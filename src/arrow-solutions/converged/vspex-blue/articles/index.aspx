<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ArrowNA.arrow_solutions.converged.vspex_blue.articles.index" %>
...
<body>
    ...
    <div class="page-title-block arrow-solutions-bg">
        ...
        / <span style="font-weight: 400; font-size: 20pt;">Articles</span>
    </div>
    <div class="site-content" style="margin-bottom: 120px; text-align: left;">
        ...
        <div class="container techinical_resources">
            <div class="row">
                <div class="col-md-4">
                    <a target="_blank" href="http://www.crn.com/news/storage/300075547/evo-rail-anyone-emc-plans-vspex-hyper-converged-infrastructure-appliance.htm">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/crn-story.png">
                            </div>
                            <p>
                ...
                <div class="col-md-4">
                    <a target="_blank" href="https://community.emc.com/docs/DOC-42719?M=DA55B204-F3EB-4018-AE92-903403A5135F">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/5Key.png">
                            </div>
                            <p>
                                Learn to sell VSPEX BLUE
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a target="_blank" href="https://community.emc.com/docs/DOC-42719?M=DA55B204-F3EB-4018-AE92-903403A5135F">
                        <div class="aa_icon">
                            <div class="aa_icon-img">
                                <img src="http://arrowenablement.blue/images/community-emc-com-docs-DOC-42719M-DA55B204-F3EB-4018-AE92-903403A5135F.png">
                            </div>
                            <p>
                                5 Key Tools to Sell VSPEX BLUE
                            </p>
                        </div>
                    </a>
                </div>
