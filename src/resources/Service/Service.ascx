<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Service.ascx.cs" Inherits="ArrowNA.resources.Service.Service" %>
  <div class="site-content" style="margin-bottom: 120px; text-align: left;">
    ...
    <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3">
                 <asp:HyperLink ID="IntegrationServices1" runat="server" NavigateUrl="~/Services/integration/index.aspx" class="as_icon-link">
                ...
                <div class="col-sm-3">
                      <asp:HyperLink ID="RemoteServices1" runat="server" NavigateUrl="~/Services/remote/index.aspx" class="as_icon-link">
                ...
                <div class="col-sm-3">
                       <asp:HyperLink ID="ResidencyServices1" runat="server" NavigateUrl="~/Services/residency/index.aspx" class="as_icon-link">
                ...
                <div class="col-sm-3">
                                   <asp:HyperLink ID="ValueRecoveryServices1" runat="server" NavigateUrl="~/Services/value-recovery/index.aspx" class="as_icon-link">
